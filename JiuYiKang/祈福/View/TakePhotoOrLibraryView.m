...
@interface TakePhotoOrLibraryView()<UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIPickerViewDelegate,UIPickerViewDataSource>
...
@end
@implementation TakePhotoOrLibraryView
...
-(instancetype)initWithFrame:(CGRect)frame andController:(id)showPhotoController andCallBackBlock:(PhotoCallBackBlock)block
{
    ...
    [cameraButt setTitle:@"相机" forState:UIControlStateNormal];
    cameraButt.layer.borderWidth=1;
    cameraButt.layer.borderColor=[UIColor redColor].CGColor;
    [cameraButt setTitleColor:[UIColor redColor] forState:UIControlStateNormal];
    ...
    [libraryButt setTitle:@"相册" forState:UIControlStateNormal];
    libraryButt.layer.borderWidth=1;
    libraryButt.layer.borderColor=[UIColor redColor].CGColor;
    [libraryButt setTitleColor:[UIColor redColor] forState:UIControlStateNormal];
...
-(void)sureButtAction:(UIButton*)tempButt
{
    ...
    {
    self.pickerDataBlock([self.pickerDataSource firstObject], nil);
    }else
    {
