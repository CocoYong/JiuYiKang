//
//  HealthRequireViewController.m
//  JiuYiKang
//
//  Created by MrZhang on 2017/8/26.
//  Copyright © 2017年 MrZhang. All rights reserved.
//

#import "HealthRequireViewController.h"

@interface HealthRequireViewController ()
@property (weak, nonatomic) IBOutlet UIWebView *webView;

@end

@implementation HealthRequireViewController
...
//    NSDictionary *paramsDic=@{@"token":MYGETNSUSERDEFAULTSDEFINE(@"token")};
    [ZYDataRequest requestHTMLString:@"Home/Account/health" params:nil andRequestMethod:@"GET" block:^(NSObject *result) {
