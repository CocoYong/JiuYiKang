...
#import "SickAndHurtViewController.h"
@interface SickAndHurtViewController ()
@property (weak, nonatomic) IBOutlet UIWebView *webView;
@end

@implementation SickAndHurtViewController
...
{
    [ZYDataRequest requestHTMLString:@"Home/Account/disability" params:nil andRequestMethod:@"GET" block:^(NSObject *result) {
